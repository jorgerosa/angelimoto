...
tCount = 0;
var texts = [ 
'Photo: Exploring the Valley',
'Photo: Planning Adventures',
'Photo: Moments for Eternity',
'Photo: Tranquil Moments',
'Photo: Rare Oasis',
'Photo: Legends and Myths',
'Photo: Livraria Lello - Since 1906 - Porto (Portugal)',
'Photo: Sintra (Portugal)',
'Photo: Sintra (Portugal)',
'Photo: The Best Gastronomy - Elvas (Portugal)',
'Photo: Elvas (Portugal)',
'Photo: Madeira (Portugal)',
'Photo: Amazing Landscapes',
'Photo: Classic Sailboats - Rio Tejo - Lisboa (Portugal)',
'Photo: Kayan Women - Myanmar (Burma)',
'Photo: Sintra (Portugal)',
'Photo: People from our Land (Portugal)',
'Photo: Porto (Portugal)',
'Photo: Cascais Bay (Portugal)',
'Photo: Cascais Beach (Portugal)'
];
...
(function($) {
    ...
    function loading() {
		...
		// Display my texts:
		$("#comment").html(texts[tCount]); tCount += 1;
